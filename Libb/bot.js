...
REPO_LINK: process.env.REPO_LINK || "https://github.com/Arslan-MD/𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD",
REPO_NAME: process.env.REPO_NAME || "𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD",
BOT_NAME: process.env.BOT_NAME || "𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD",
DESCRIPTION: process.env.DESCRIPTION || "𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮 MD PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "923392616263",
OWNER_NAME: process.env.OWNER_NAME || "ArslanMD Official",
ST_SAVE: process.env.ST_SAVE || "𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD-BY OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY 𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD`* _*POWERD BY*_ *ArslanMD Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ 𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD OFFICIAL*",
VERSION: process.env.VERSION || "9.0.0",
NEWSLETTER: process.env.NEWSLETTER || "120363348739987203@newsletter",
WA_CHANNEL: process.env.WA_CHANNEL || "",
INSTA: process.env.INSTA || "https://www.instagram.com/sonupracha786?stkn=MTA5eTB3YnBsMDRsNw=",
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/WvsDQ2Cn/FB-IMG-1785695038321.jpg",
OWNER_IMG: process.env.OWNER_IMG || "https://i.ibb.co/WvsDQ2Cn/FB-IMG-1785695038321.jpg",
...
NEWS_IMG: process.env.NEWS_IMG || "https://i.ibb.co/WvsDQ2Cn/FB-IMG-1785695038321.jpg",
PP_IMG: process.env.PP_IMG || "https://i.ibb.co/WvsDQ2Cn/FB-IMG-1785695038321.jpg"
};
