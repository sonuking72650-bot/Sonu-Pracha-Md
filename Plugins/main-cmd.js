...
console.log(`𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from, contextInfo, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD-ENV* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *𝔼ℕ𝕍 𝕊𝔼𝕋𝕋𝕀ℕ𝔾𝕊 📡*
┃▸└───────────···๏
╰────────────────┈⊷
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerName = '𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮MD Official'; // Replace this with the owner's name
        const organization = '𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮 CODERS'; // Optional: replace with the owner's organization
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD..._*'  }, { quoted: mek } )
...
try{
let dec = `> 𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ 𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD REPO: ${bot.REPO_LINK} 
┃
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        const vv = await conn.sendMessage(from, {
            image: { url:bot.ALIVE_IMG},
            caption: `> 𝗦𝗼𝗻𝘂 𝗣𝗿𝗮𝗰𝗵𝗮-MD Settings\n
┏━━━━━━━━━━━━━━━━━━┓
┃╭┈────────━━━━───╮
┣┣Work Mode : *${work}*
